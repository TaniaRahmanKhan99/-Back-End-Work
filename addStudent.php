...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $register = $reg->addStudent($_POST, $_FILES);  
}
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                           ...
                           <input class="a btn btn-success form-control" style="color:white; background-color:#ff99bb" type="submit" name="submit" value="ADD STUDENT" >
                           <br>
						   <br>
